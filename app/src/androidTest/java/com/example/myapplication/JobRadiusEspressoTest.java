...
public class JobRadiusEspressoTest {
    ...
    public static void createEmployerAndJob(){
        ...
        ActivityScenario.launch(VeteranActivity.class);
        onView(withId(R.id.veteranView)).check(matches(isDisplayed()));
        onView(withId(R.id.veteranCreateJob)).perform(click());

        ActivityScenario.launch(CreateJob.class);
        onView(withId(R.id.veteranCreateJob)).check(matches(isDisplayed()));
    ...
    public void testUserGetsJobsWithinRadius()
    {
        ...
        Espresso.closeSoftKeyboard();
        onView(withId(R.id.registerButton)).perform(click());
        onView(withId(R.id.volunteerSeeJobTenKm)).perform(click());
